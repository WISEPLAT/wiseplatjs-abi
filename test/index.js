...
// Official test vectors from https://github.com/wiseplat/wiki/wiki/Wiseplat-Contract-ABI
...
describe('utf8 handling', function () {
  it('should encode latin and extensions', function () {
    var a = abi.rawEncode([ 'string' ], [ 'wiseplat számítógép' ]).toString('hex')
